    ...
    <div class="main-container">
        <div class="header">
            ...
            <div class="header-actions">
                <a href="vehicles_request.php" class="btn btn-back">
        ...
        <div class="action-buttons">
           <form action="vehicles_accept.php" method="POST" style="display:inline;">
                <input type="hidden" name="id" value="<?php echo $vehicle['id_vehiculo']; ?>">
                <button type="submit" class="btn btn-accept" title="Aceptar">
                    <i class="bi bi-check-lg">Aceptar solicitud</i>
                </button>
            </form>

            <form action="vehicles_decline.php" method="POST" style="display:inline;">
                <input type="hidden" name="id" value="<?php echo $vehicle['id_vehiculo']; ?>">
            ...
            <!-- agregar modal para confirmar rechazar y aceptar solicitud -->
        </div>
    </div>
</body>
</html>
